window.fbAsyncInit = function() {
    ...
    document.querySelector('.create-post').addEventListener("click", async () => {
        ...
        const respMedia = await fetch(`https://graph.facebook.com/${bussines_accounts.id}/media?media_type=VIDEO&video_url=${videoURL}&caption=Hey&access_token=${user.accessToken}`, {
            method: "POST"
        })
